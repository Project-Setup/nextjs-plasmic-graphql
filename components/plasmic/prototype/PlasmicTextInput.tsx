...
// Plasmic Project: ncsM16dhWSYZH3JuSmyesJ
// Component: P3VtCTfrGI3
...
import projectcss from './plasmic_prototype.module.css'; // plasmic-import: ncsM16dhWSYZH3JuSmyesJ/projectcss
import sty from './PlasmicTextInput.module.css'; // plasmic-import: P3VtCTfrGI3/css

import SearchsvgIcon from './icons/PlasmicIcon__Searchsvg'; // plasmic-import: G17g21NB9Gz/icon
import ChecksvgIcon from './icons/PlasmicIcon__Checksvg'; // plasmic-import: dCKa1mFiM_m/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__wxOg0)}
                role={'img'}
              />
            ),
      ...
      {(hasVariant(variants, 'showEndIcon', 'showEndIcon') ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__neGMa)}
                role={'img'}
              />
            ),
